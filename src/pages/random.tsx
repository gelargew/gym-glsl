...
import RandomShader from '../shaders/random.shader'


const RandomMaterial = shaderMaterial(...RandomShader)
  
extend({ RandomMaterial })
...
function Obj() {
    ...
    return (
      <Box ref={plane} args={[3, 4, 5, 100]} position={[1, 0, 0]} rotation={[1, 0, 1]} >
        <randomMaterial side={THREE.DoubleSide} time={0} resolution={[size.width, size.height, 1]} />
      </Box>
    )
  }